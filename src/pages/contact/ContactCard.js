                ...
                <Container style={{margin:20}}>
                    <Row>
                        <Col sm="12" md={{ size: 8, offset: 2 }}>
                            <h2><Badge style={{borderRadius:20}}>Contact us</Badge></h2>
                            <Form>
                                <FormGroup>
                                ...
                                <FormGroup>
                                    ...
                                    <Input type="text" name="text" id="exampleText" placeholder="Enter Your Company/Position" />
                                </FormGroup>
                                <FormGroup>
                                    <Label for="examplePhone">*Phone</Label>
                                    <Input type="phone" name="phone" id="examplePhone" placeholder="Enter Your Phone" />
                                </FormGroup>
                                <FormGroup>
